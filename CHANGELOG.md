...
### Changed
- Version kept in step with `opsight-ai-governance` 1.8.7 (its Dependabot actions bump); the two repos are one product release.

## [1.8.6] - 2026-09-16

### Changed
- Dependencies: bump the actions group with 2 updates (Dependabot).
